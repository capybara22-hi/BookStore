                        ...
                        <div class="dropdown account-dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="dropdown-footer">
                                    <a href="{{ route('dangnhap') }}" class="btn btn-primary w-100 mb-2">Sign In</a>
                                    <a href="{{ route('dangky') }}" class="btn btn-outline-primary w-100">Register</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container-fluid container-xl position-relative">
                <nav id="navmenu" class="navmenu">
                    <ul>
                        ...
                        <li><a href="{{ route('sanpham') }}">Category</a></li>
                        <li><a href="#">Product Details</a></li>
                        <li><a href="{{ route('giohang') }}">Cart</a></li>
                        <li><a href="{{ route('thanhtoan') }}">Checkout</a></li>
