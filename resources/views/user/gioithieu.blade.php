    ...
    <div class="header-nav">
      <div class="container-fluid container-xl position-relative">
        <nav id="navmenu" class="navmenu">
          <ul>
            <li><a href="home.blade.php" class="active">Trang Chủ</a></li>
            <li><a href="gioithieu.blade.php" class="active">Giới Thiệu</a></li>

            <!-- Products Mega Menu 1 -->
            <li><a href="danhmuc.blade.php" class="active">Sản phẩm</a></li>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row mt-5">
          <div class="col-lg-12" data-aos="zoom-in" data-aos-delay="200">
            <div class="video-box">
              <img src="../../../public/assets/img/about/about-wide-1.webp" class="img-fluid" alt="Video Thumbnail">
        ...
        <div class="testimonial-masonry">
            ...
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="../../../public/assets/img/person/person-f-7.webp" alt="Client">
                </div>
          ...
          <div class="testimonial-item highlight" data-aos="fade-up" data-aos-delay="100">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="../../../public/assets/img/person/person-m-7.webp" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Daniel Morgan</h3>
          ...
          <div class="testimonial-item" data-aos="fade-up" data-aos-delay="200">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="../../../public/assets/img/person/person-f-8.webp" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Emma Thompson</h3>
          ...
          <div class="testimonial-item" data-aos="fade-up" data-aos-delay="300">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="../../../public/assets/img/person/person-m-8.webp" alt="Client">
                </div>
                <div class="client-details">
          ...
          <div class="testimonial-item highlight" data-aos="fade-up" data-aos-delay="400">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="../../../public/assets/img/person/person-f-9.webp" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Olivia Carter</h3>
          ...
          <div class="testimonial-item" data-aos="fade-up" data-aos-delay="500">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="../../../public/assets/img/person/person-m-13.webp" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Nathan Brooks</h3>
