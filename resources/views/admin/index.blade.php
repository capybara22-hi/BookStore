              ...
              >
                ...
                <div>
                  ...
                  <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
                  >
                  @php $count = 0; $check = 0; @endphp
                    @foreach($don_hang as $dh)
                        @if($dh->trang_thai_dh == 1)
                            @php echo ++$count; $check = 1; @endphp
                        @endif
                    @endforeach
                  @php if($check == 0){echo '0';} @endphp
                  </p>
                </div>
              </div>
              <!-- Card -->
              ...
              >
                ...
                <div>
                  <p
                    class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400"
                  >
                    Tổng đơn hàng đang chuẩn bị
                  </p>
                  <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
                  >
                  @php $count1 = 0; $check2 = 0; @endphp
                    @foreach($don_hang as $dh)
                        @if($dh->trang_thai_dh == 2)
                            @php echo ++$count1 ; $check2 = 1; @endphp
                        @endif
                    @endforeach
                  @php if($check2 == 0){echo '0';} @endphp
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
                  >
                  @php $count2 = 0; $check2 = 0; @endphp
                    @foreach($don_hang as $dh)
                        @if($dh->trang_thai_dh == 3)
                            @php echo ++$count2 ; $check2 = 1; @endphp
                        @endif
                    @endforeach
                    @php if($check2 == 0){echo '0';} @endphp
                  </p>
              ...
              >
                ...
                <div>
                  <p
                    class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400"
                  >
                    Tổng yêu cầu hủy đơn hàng
                  </p>
                  <p
                    class="text-lg font-semibold text-gray-700 dark:text-gray-200"
                  >
                  @php $count3 = 0; $check3 = 0; @endphp
                    @foreach($don_hang as $dh)
                        @if($dh->trang_thai_dh == 5)
                            @php echo ++$count3 ; $check3 = 1; @endphp
                        @endif
                    @endforeach
                   @php if($check3 == 0){echo '0';} @endphp
                  </p>
                </div>
              </div>
            </div>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">{{ $nd->name}}</p>
                          </div>
                        </div>
                      </td>
