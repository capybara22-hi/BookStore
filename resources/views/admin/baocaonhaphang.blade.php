                ...
                <table class="w-full whitespace-no-wrap">
                  ...
                  >
                            ...
                            <td class="px-4 py-3">
                                ...
                                <div>
                                    <p class="font-semibold">File mẫu nhập hàng</p>
                                </div>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-sm">
                                <Button style="background:green; color: white; width: 150px ; height: 30px; border-radius: 10px; border: 1px;
                                ">Tải file excel mẫu</Button>
                            </td>
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm">
                                
                                <div>
                                    <p class="font-semibold">Nhập hàng vào giỏ hàng</p>
                                </div>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-sm">
